...
from .forms import (
    ...
    get_address_form, logout_on_password_change, PopupSignUp, PopupLoginForm)
...
class PopupLoginView(LoginAjaxMixin, SuccessMessageMixin, LoginView):
    authentication_form = PopupLoginForm
...
class SignupView(PassRequestMixin, SuccessMessageMixin, generic.CreateView):
    form_class = PopupSignUp
    template_name = 'account/signup_modal.html'
    success_message = 'Success: Sign up successed. You can now Log in.'
