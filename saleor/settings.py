...
GMAIL_USERNAME = 'fishondgi@gmail.com'
GMAIL_PASSWORD = 'fishOnDGI08042019'
if not EMAIL_URL and GMAIL_USERNAME and GMAIL_PASSWORD:
    EMAIL_URL = 'smtp://%s:%s@smtp.gmail.com:465/?ssl=True' % (
...
STATICFILES_DIRS = [
    ...
    ('custom_assets', os.path.join(PROJECT_ROOT, 'saleor', 'static', 'custom_assets')),
...
SECRET_KEY = "abcdefghijklmnoopqr28384ngl;389"
